...
const LogonOverlay: React.FC<{tokenSourceUid:string}> = ({tokenSourceUid}) => {
  ...
  */
  ...
  return (
    <div className="shell__signin_container">
      <iframe src={oauthServerAuthUrl} width="100%" >
        please wait...
      </iframe>
      <div>
        Problems caused by iframe-restrictions? <a href={oauthServerAuthUrl} target="_blank">Open in separate Window</a>
      </div>
      <button
                type="primary"
                htmlType="submit"
